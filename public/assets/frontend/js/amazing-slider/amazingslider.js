    ...
    $.fn.amazingslider = function(options) {
        ...
        AmazingSlider.prototype = {
            ...
            createNav: function() {
                ...
                if(this.options.shownavcontrol == "home"){
                ...
                else if (this.options.shownavcontrol || typeof this.options.shownavcontrol == "undefined") {
                    $nav.css({
                        display: "block",
                        position: "absolute",
                        height: "auto"
                    ...
                    if (instance.options.navshowpreview) {
                        ...
                        $(imgLoader).load(function() {
                            ...
                            if (this.width / this.height <= instance.options.navpreviewwidth / instance.options.navpreviewheight) style = "width:" + instance.options.navpreviewwidth + "px;height:auto;margin-top:-" + Math.floor(this.height / this.width * instance.options.navpreviewwidth / 2 - instance.options.navpreviewheight / 2) + "px";
                                ...
                                style = "width:auto;height:" + instance.options.navpreviewheight + "px;margin-left:-" + Math.floor(this.width / this.height * instance.options.navpreviewheight / 2 - instance.options.navpreviewwidth / 2) + "px";
            ...
            slideRun: function(index, playVideo) {
                ...
                if (this.isAnimating) {
                    ...
                    $(".amazingslider-img-box-" + this.id, this.container).unbind("transitionFinished").html("<div class='amazingslider-img-" + this.id + " ' style='display:block;position:absolute;left:0px;top:0px;width:100%;height:auto;overflow:hidden;'><img style='position:absolute;max-width:100%;width:100%;height:100%;left:0%;top:0%;' src='" + this.elemArray[savedCur][ELEM_SRC] + "' /></div>");
            ...
            showImage: function(slideDirection) {
                ...
                $(imgLoader).load(function() {
                    ...
                    var $imgCur = $("<div class='amazingslider-img-" + instance.id + " ' style='display:block;position:absolute;left:0px;top:0px;width:100%;height:100%;overflow:hidden;'><img style='position:absolute;" + (ASPlatforms.isIE678() ? "opacity:inherit;filter:inherit;" : "") + "max-width:" + ratio + "%;width:100%;height:100%;left:" + (100 - ratio) / 2 + "%;top:0%;' src='" + instance.elemArray[instance.curElem][ELEM_SRC] + "' /></div>");
