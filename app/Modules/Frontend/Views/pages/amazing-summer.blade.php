  ...
  <section class="six-skill">
    <div class="container-fluid">
        <div class="row flex-items-end">
            ...
            <div class="col-sm-5">
                <div class="box-img">
                    <img src="{!!asset('public/assets/frontend')!!}/images/amazinng-summer/six-skill-01.png" alt="">
                </div>
            </div>
        </div>
    </div>
...
<div class="container">
  <section class="kiddom">
    <div class="container-fluid">
        <div class="row flex-items-end">
            <div class="col-sm-4">
                <img src="{!!asset('public/assets/frontend')!!}/images/amazinng-summer/kiddoom-01.png" alt="">
            </div>
            <div class="col-sm-8">
