...
@section('script')
  <link rel="stylesheet" href="<?php echo asset('public/vendor/dropzoner/dropzone/dropzone.min.css'); ?>">
  <script src="<?php echo asset('public/vendor/dropzoner/dropzone/dropzone.min.js'); ?>"></script>
    ...
    $(document).ready(function(){
      ...
      var myDropzone = new Dropzone(document.body, { // Make the whole body a dropzone
        ...
        success: function(file,response) {
            ...
            window.location = "{!!route('admin.image.index')!!}";
        },
